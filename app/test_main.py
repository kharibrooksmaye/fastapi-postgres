...
def test_update_book():
    updated_book = Book(title="Animal Farm", author="George Orwell", published_year=1945, genre="Dystopian", summary="A dystopian novel",  call_number=123.456, is_checked_out=False)
